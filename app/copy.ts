...
// languages must satisfy, so a missing translation is a compile error. Text
// stored on the server (household greeting, meal names and descriptions)
// renders as saved and is not translated here.
