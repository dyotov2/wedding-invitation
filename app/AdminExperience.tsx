  ...
  return (
    <main className="admin-page">
      ...
      <section className="admin-content">
        ...
        <p className="admin-status" role="status">{status}</p>
        <div className="admin-date-notice"><strong>Initial RSVP requested by {formatPolicyDate(data?.rsvpDeadline, "31 December 2026")}</strong><span>Late replies remain possible; wedding data is scheduled for deletion on {formatPolicyDate(data?.deletionDate, "27 June 2027")}.</span></div>
